...
if SYMBOLS:
    ...
    SYMBOLS = [
    "ALPACAUSDT","ALPINEUSDT","BNXUSDT","BSWUSDT","MYXUSDT",
    "NEIROETHUSDT","VIDTUSDT","AEVOUSDT","AKEUSDT","ALPHAUSDT",
    "COAIUSDT","AMBUSDT","MEMEFIUSDT","SQDUSDT","1000SATSUSDT",
    "OCEANUSDT","AGIXUSDT","XPLUSDT","LIGHTUSDT","STBLUSDT",
    "UBUSDT","LEVERUSDT","KAITOUSDT","LINAUSDT","MIRAUSDT",
    "BLESSUSDT","STRAXUSDT","HANAUSDT","HUSDT","ORDERUSDT",
    "SNXUSDT","FTMUSDT","UXLINKUSDT","IPUSDT","0GUSDT",
    "ZKCUSDT","UNFIUSDT","OMNIUSDT","ASTERUSDT","BARDUSDT"
]
