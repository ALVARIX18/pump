...
if SYMBOLS:
    ...
    SYMBOLS = [
    "BNBUSDT","SOLUSDT","XRPUSDT","DOGEUSDT","ADAUSDT","DOTUSDT","MATICUSDT","LINKUSDT","AVAXUSDT","TRXUSDT",
    "NEARUSDT","SUIUSDT","ATOMUSDT","ICPUSDT","FILUSDT","THETAUSDT","EOSUSDT","CHZUSDT","XLMUSDT","UNIUSDT",
    "AAVEUSDT","SNXUSDT","SUSHIUSDT","CRVUSDT","LTCUSDT","BCHUSDT","ZECUSDT","ARBUSDT","MANAUSDT","GALAUSDT",
    "FTMUSDT","KSMUSDT","KAVAUSDT","ZILUSDT","VETUSDT","CELOUSDT","LRCUSDT","ONTUSDT","BTTUSDT","ALGOUSDT",
    "RUNEUSDT","CHESSUSDT","APTUSDT","WOOUSDT","TRIBEUSDT","STORJUSDT","ZENUSDT"
]
...
SCORE_SIGNAL = int(os.environ.get("SCORE_SIGNAL", 85))
...
if SYMBOLS:
    ...
    SYMBOLS = [
    "XRPUSDT","DOGEUSDT","ADAUSDT","SOLUSDT","MATICUSDT","DOTUSDT","LTCUSDT",
    "AVAXUSDT","UNIUSDT","ATOMUSDT","LINKUSDT","AAVEUSDT","NEARUSDT","MANAUSDT",
    "SANDUSDT","APEUSDT","GALAUSDT","BCHUSDT","EOSUSDT","FILUSDT","XTZUSDT",
    "LRCUSDT","TRXUSDT","ETCUSDT","XLMUSDT","XMRUSDT","DASHUSDT","ZECUSDT",
    "ZILUSDT","KNCUSDT","COMPUSDT","OMGUSDT","SXPUSDT","KAVAUSDT","BANDUSDT",
    "CRVUSDT","SUSHIUSDT","EGLDUSDT","ENJUSDT","FLMUSDT","KSMUSDT","AXSUSDT",
    "ARBUSDT","SUIUSDT","PEPEUSDT","FLOKIUSDT","OPUSDT","WOOUSDT","GMTUSDT",
    "LDOUSDT","ARPAUSDT","COMPUSDT","KSMUSDT"
]
