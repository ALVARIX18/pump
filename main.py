...
if SYMBOLS:
    ...
    "AVAXUSDT", "DOTUSDT", "MATICUSDT", "LINKUSDT", "TRXUSDT", "ATOMUSDT",
    "NEARUSDT", "APTUSDT", "FILUSDT", "SUIUSDT", "TIAUSDT", "ARBUSDT", "SEIUSDT",
    "JASMYUSDT", "PEPEUSDT", "BONKUSDT", "NOTUSDT", "ARKMUSDT", "OPUSDT", "IMXUSDT",
    "RNDRUSDT", "INJUSDT", "FTMUSDT", "GALAUSDT", "MANAUSDT", "SANDUSDT", "AAVEUSDT",
    "CRVUSDT", "SNXUSDT", "UNIUSDT", "SUSHIUSDT", "DYDXUSDT", "COMPUSDT", "YFIUSDT",
    "EGLDUSDT", "THETAUSDT", "FLOWUSDT", "CHZUSDT", "XLMUSDT", "VETUSDT", "LTCUSDT",
    "BCHUSDT", "ZECUSDT", "ICPUSDT", "KAVAUSDT", "CELOUSDT", "WAVESUSDT", "HOTUSDT",
...
SCORE_ALERT = int(os.environ.get("SCORE_ALERT", 85))
PRE_SIGNAL = int(os.environ.get("PRE_SIGNAL", 92))
