...
if SYMBOLS:
    ...
    SYMBOLS = [
    "HUSDT","FORMUSDT","KAITOUSDT","PUMPUSDT","ALPINEUSDT",
    "IPUSDT","SKLUSDT","0GUSDT","SUNUSDT","OMUSDT",
    "WLFIUSDT","SOLUSDT","ENAUSDT","LINKUSDT","BCHUSDT",
    "PENGUUSDT","AVAXUSDT","ADAUSDT","WLDUSDT","ZKCUSDT",
    "WAVAXUSDT","XRPUSDT","WETHUSDT","CRVUSDT","ETHUSDT",
    "EIGENUSDT","LINEAUSDT","WBNBUSDT","BNBUSDT","DOGEUSDT",
    "XLMUSDT","UNIUSDT","CBBTCUSDT","AAVEUSDT","DOTUSDT",
    "BTCUSDT","APTUSDT","SUIUSDT"
]
...
SCORE_SIGNAL = int(os.environ.get("SCORE_SIGNAL", 100))
SCORE_ALERT = int(os.environ.get("SCORE_ALERT", 80))
PRE_SIGNAL = int(os.environ.get("PRE_SIGNAL", 80))
