...
if SYMBOLS:
    ...
    "AVAXUSDT","LINKUSDT","ATOMUSDT","NEARUSDT","SUIUSDT",
    "APTUSDT","ARBUSDT","OPUSDT","ICPUSDT","FILUSDT",
    "LTCUSDT","BCHUSDT","ETCUSDT","XLMUSDT","ALGOUSDT",
    "HBARUSDT","VETUSDT","FLOWUSDT","EGLDUSDT","THETAUSDT",
    "GALAUSDT","MANAUSDT","SANDUSDT","AXSUSDT","AAVEUSDT",
    "CRVUSDT","SNXUSDT","UNIUSDT","SUSHIUSDT","COMPUSDT"
]
