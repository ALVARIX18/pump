...
if SYMBOLS:
    ...
    "DOTUSDT", "MATICUSDT", "LTCUSDT", "AVAXUSDT", "TRXUSDT", "LINKUSDT",
    "ATOMUSDT", "NEARUSDT", "APTUSDT", "FILUSDT", "SANDUSDT", "AXSUSDT", "AAVEUSDT",
    "FTMUSDT", "EGLDUSDT", "THETAUSDT", "GALAUSDT", "RUNEUSDT", "MANAUSDT", "FLOWUSDT",
    "XTZUSDT", "ICPUSDT", "KSMUSDT", "ZECUSDT", "CHZUSDT", "SNXUSDT", "CRVUSDT",
    "DYDXUSDT", "ENSUSDT", "LRCUSDT", "ONEUSDT", "CELOUSDT", "BATUSDT", "XLMUSDT",
    "VETUSDT", "ICXUSDT", "QTUMUSDT", "OMGUSDT", "DASHUSDT", "WAVESUSDT", "COMPUSDT",
    "YFIUSDT", "UNIUSDT", "SUSHIUSDT", "BCHUSDT", "ZILUSDT", "HOTUSDT", "ANKRUSDT",
    "KAVAUSDT", "CVCUSDT", "MTLUSDT", "SKLUSDT"
]
...
SCORE_ALERT = int(os.environ.get("SCORE_ALERT", 87))
PRE_SIGNAL = int(os.environ.get("PRE_SIGNAL", 86))
