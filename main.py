...
if SYMBOLS:
    ...
    "TRXUSDT","UNIUSDT","LTCUSDT","DOGEUSDT","ATOMUSDT",
    "FILUSDT","FTMUSDT","SUIUSDT","NEARUSDT","ALGOUSDT",
    "AXSUSDT","ICPUSDT","EOSUSDT","CHZUSDT","AAVEUSDT",
    "MKRUSDT","SANDUSDT","GRTUSDT","SNXUSDT","APEUSDT",
    "RUNEUSDT","XLMUSDT","HBARUSDT","ENJUSDT","KSMUSDT",
    "ZILUSDT","COMPUSDT","FLOWUSDT","THETAUSDT","GALAUSDT",
    "MANAUSDT","VETUSDT","BCHUSDT","ZECUSDT","KAVAUSDT"
]
