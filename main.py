...
if SYMBOLS:
    ...
    SYMBOLS = [
    "BTCUSDT","ETHUSDT","BNBUSDT","SOLUSDT","XRPUSDT","ADAUSDT","DOTUSDT","MATICUSDT",
    "LINKUSDT","AVAXUSDT","TRXUSDT","UNIUSDT","LTCUSDT","DOGEUSDT","ATOMUSDT","FILUSDT",
    "FTMUSDT","SUIUSDT","NEARUSDT","ALGOUSDT","AXSUSDT","ICPUSDT","EOSUSDT","CHZUSDT",
    "AAVEUSDT","MKRUSDT","SANDUSDT","GRTUSDT","CRVUSDT","SNXUSDT","APEUSDT","WAVESUSDT",
    "RUNEUSDT","ZRXUSDT","XLMUSDT","AVAXUSDT","HBARUSDT","ENJUSDT","KSMUSDT","ZILUSDT",
    "COMPUSDT","FLOWUSDT","FTTUSDT","THETAUSDT","GALAUSDT","MANAUSDT","VETUSDT","CELOUSDT",
    "BCHUSDT","ZECUSDT","KAVAUSDT","CHESSUSDT","BTTUSDT","SUSHIUSDT","CRVUSDT","NEARUSDT"
]
...
SCORE_SIGNAL = int(os.environ.get("SCORE_SIGNAL", 84))
