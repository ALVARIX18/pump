...
if SYMBOLS:
    ...
    SYMBOLS = [
    "BTCUSDT","ETHUSDT","BNBUSDT","SOLUSDT","XRPUSDT","DOGEUSDT","ADAUSDT","DOTUSDT","MATICUSDT","LINKUSDT",
    "AVAXUSDT","TRXUSDT","NEARUSDT","SUIUSDT","ATOMUSDT","ICPUSDT","FILUSDT","THETAUSDT","EOSUSDT","CHZUSDT",
    "XLMUSDT","UNIUSDT","AAVEUSDT","SNXUSDT","SUSHIUSDT","CRVUSDT","LTCUSDT","BCHUSDT","ZECUSDT","ARBUSDT",
    "MANAUSDT","GALAUSDT","FTMUSDT","KSMUSDT","KAVAUSDT","ZILUSDT","VETUSDT","CELOUSDT","LRCUSDT","ONTUSDT",
    "BTTUSDT","ALGOUSDT","RUNEUSDT","CHESSUSDT","APTUSDT","WOOUSDT","TRIBEUSDT","STORJUSDT","ZENUSDT"
]
